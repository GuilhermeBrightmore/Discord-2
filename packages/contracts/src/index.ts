...
export const messageReplySchema = z.object({ id: z.string().uuid(), body: z.string(), author: profileSchema.optional() });
export const messageSchema = z.object({ id: z.string().uuid(), channelId: z.string().uuid(), authorId: z.string().uuid(), body: z.string().min(1).max(4000), createdAt: z.string(), editedAt: z.string().nullable(), replyToId: z.string().uuid().nullable().optional(), reply: messageReplySchema.nullable().optional(), author: profileSchema.optional() });
